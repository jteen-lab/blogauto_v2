                            ...
                            <div class="space-y-4 border border-amber-200 bg-amber-50/40 rounded-lg p-4">
                                ...
                                <div class="space-y-2 pb-3 border-b border-amber-200">
                                    ...
                                    <div class="pl-6 pt-2 space-y-1">
                                        <label class="text-xs font-medium text-gray-700">승인 전 사용할 프리셋</label>
                                        <p class="text-[11px] text-gray-500">
                                            승인 <strong>전</strong>에는 이 프리셋으로 글을 씁니다.
                                        ...
                                        <p class="text-[11px]"
                                           ...
                                           x-text="promptModule.adsense.approvalPreset
                                               ? '승인 전에는 이 프리셋으로, 승인 후에는 평소 프롬프트로 생성됩니다'
                                               : '항상 평소 프롬프트로 생성됩니다'"></p>
                                    </div>
                                </div>
...
// 제목 재조합 설정 섹션은 prompt-form-title-section.js 로 옮겼다
