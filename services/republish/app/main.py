...
from .routers.cpa_assets import router as cpa_assets_router
...
from .routers.promo_links import router as promo_links_router  # 홍보 링크
...
app.include_router(cpa_assets_router, prefix=settings.api_v1_prefix)
