...
DEFAULTS: Dict[str, dict] = {
    ...
    "similarity_threshold": {"value": "75", "type": "float", "category": "similarity", "desc": "그룹핑 임계값(이상 그룹)=회색지대 상한(0-100)"},
    "similarity_gray_lower": {"value": "68", "type": "float", "category": "similarity", "desc": "회색지대 하한(이하 분리). 하한~임계값은 AI 판정"},
