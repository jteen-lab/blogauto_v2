...
TEMPLATES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "prompts": {
            "emotional": "감각어를 하나 넣을 것. 예: 진한 / 바삭한 / 조용한",
            "practical": ("장소·시간·인원 중 하나를 넣을 것. "
                          "예: 성수동 / 주말 오후 / 4인"),
            "question": ("선택을 묻는 형태로 쓸 것. "
                         "예: 어디가 / 뭘 먹을까 / 어떤 코스"),
            "viral": "의외성을 넣을 것. 예: 현지인만 아는 / 간판 없는",
    ...
    },
    {
        ...
        "prompts": {
            "emotional": ("곤란한 상황을 앞에 둘 것. "
                          "예: 갑자기 안 될 때 / 처음이라면"),
            "practical": "단계 수나 소요 시간을 넣을 것. 예: 3단계 / 5분이면",
            "question": ("방법을 묻는 의문사로 시작할 것. "
                         "예: 어떻게 / 왜 안 되나"),
            "viral": "흔한 실수를 지적할 것. 예: 대부분 틀리는 / 이것만 바꾸면",
            "minimal": "대상 + 동작 명사로 끝낼 것. 예: 프린터 오류 해결",
        },
    },
    {
        "code": "prep",
        ...
        "prompts": {
            "emotional": ("준비 단계를 호명할 것. "
                          "예: 이제 막 시작했다면 / 재도전이라면"),
            "practical": "일정·기간·횟수를 넣을 것. 예: 3개월 / 접수기간 / 2회차",
            "question": ("자격이나 시기를 묻는 형태로 쓸 것. "
                         "예: 언제부터 / 누가 받을 수"),
            "viral": "놓치기 쉬운 조건을 짚을 것. 예: 모르면 못 받는 / 마감 직전",
            "minimal": "대상 + 항목 명사로 끝낼 것. 예: 전기기사 실기 일정",
        },
    },
]
