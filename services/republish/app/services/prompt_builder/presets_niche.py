...
NICHE_PRESETS: List[Dict[str, object]] = [
    ...
    # ── 보험 (36) ────────────────────────────────────────────
    {
        ...
        "match_topics": ['보험'],
        "match_subtopics": ['자동차보험', '화재·주택보험', '실손의료보험', '암·건강보험', '종신·정기보험', '어린이·태아보험'],
        "persona": "P-Analyst", "reader": "R-Decision",
    ...
    # ── 세금/절세 (15) ───────────────────────────────────────
    {
        ...
        "match_topics": ['세금/절세'],
        "match_subtopics": ['연말정산', '종합소득세', '사업자 세무', '양도소득세', '상속·증여', '부가가치세'],
        "persona": "P-Guide", "reader": "R-Applicant",
        "pattern": "P6", "tone": "T-Warning", "common": "C-YMYL",
    },
    ...
    # ── 재테크/돈관리 (167) ──────────────────────────────────
    {
        ...
        "match_subtopics": ['토큰 증권', '주식', 'ETF투자', '부업'],
    ...
    },
    {
        ...
        "categories": "재테크/돈관리 › 적금/예금(23) · 절약·가계부 · 월급 관리 · 연금·노후자금 · 앱테크",
        "match_topics": ['재테크/돈관리'],
        "match_subtopics": ['적금/예금', '절약·가계부', '월급 관리', '연금·노후자금', '앱테크'],
    ...
    # ── 시니어·부동산 ────────────────────────────────────────
    {
        ...
        "match_topics": ['시니어/노후'],
        "match_subtopics": ['연금', '노인복지', '요양·돌봄', '건강보험료', '상속·정리'],
        "persona": "P-Peer", "reader": "R-Beginner",
    ...
    },
    {
        ...
        "match_topics": ['부동산'],
        "match_subtopics": ['매매·청약', '전월세 계약', '부동산 세금·비용', '전세사기 예방', '재개발·재건축', '임대사업', '이사·인테리어'],
        "persona": "P-Analyst", "reader": "R-Decision",
    ...
    # ── 정부지원금/복지 (54) ─────────────────────────────────
    {
        ...
        "match_subtopics": ['정부 정책·제도', '육아·가족 지원', '소상공인 지원', '에너지·생활 지원', '실업·고용', '청년 지원', '주거 지원'],
    ...
    # ── 건강/의학 (260) — 성격이 크게 갈려 셋으로 ─────────────
    {
        ...
        "match_topics": ['건강/의학'],
        "match_subtopics": ['질병 및 증상', '증상·자가진단', '통증 관리', '원인·발병'],
    ...
    },
    {
        ...
        "match_topics": ['건강/의학'],
        "match_subtopics": ['치료·처방', '예방·관리', '병원·진료', '영양제·보충제'],
    ...
    # ── 출산/육아 (31) ───────────────────────────────────────
    {
        ...
        "match_topics": ['출산/육아'],
        "match_subtopics": ['육아팁/육아노하우', '출산 준비', '임신 준비/건강', '영유아 건강', '산후조리', '육아용품', '임산부 태교/일기'],
        "persona": "P-Peer", "reader": "R-Beginner",
        "pattern": "P5", "tone": "T-Empathy", "common": "C-YMYL",
    },
    ...
    # ── 취업/자격증 (113) ────────────────────────────────────
    {
        ...
        "match_topics": ['취업/자격증'],
        "match_subtopics": ['구인구직 사이트', '취업 정보', '연봉·처우', '이직·경력'],
    ...
    # ── 생활 정보 (774) — 재고 2위, 성격이 갈려 셋으로 ────────
    {
        ...
        "match_topics": ['생활 정보'],
        "match_subtopics": ['노하우/꿀팁', '생활 정보', '문화 정보'],
    ...
    # ── 여행/관광 (377) ──────────────────────────────────────
    {
        ...
        "match_topics": ['여행/관광'],
        "match_subtopics": ['여행 날씨·시기', '여행 경비·예산', '여행 준비물'],
    ...
    },
    {
        ...
        "match_topics": ['여행/관광'],
        "match_subtopics": ['여행 정보', '숙소·호텔', '국내여행지', '해외여행지', '여행 교통', '여행 음식·맛집'],
    ...
    # ── 컴퓨터/IT · AI ───────────────────────────────────────
    {
        ...
        "match_topics": ['컴퓨터/IT'],
        "match_subtopics": ['PC·윈도우', '주변기기', '프로그램·오피스', '인터넷·보안', '코딩'],
    ...
    # ── 자동차 · 쇼핑/리뷰 ───────────────────────────────────
    {
        ...
        "match_topics": ['자동차'],
        "match_subtopics": ['전기·친환경차', '신차·구매', '정비·소모품', '과태료·법규', '중고차', '사고·처리'],
    ...
    # ── 지역/업체정보 ────────────────────────────────────────
    {
        ...
        "match_subtopics": ['꽃배달', '장례·예식', '이사·청소업체', '이사짐센터', '수리·시공', '인터넷업체'],
        "persona": "P-Neutral", "reader": "R-Decision",
